...
//        IEnumerable<DTO_RewardDisciplineType> GetListRewardType(int pageSize, int pageNumber);
//        IEnumerable<DTO_RewardDisciplineType> GetListDisciplineType(int pageSize, int pageNumber);
