...
namespace BigProject.DataContext
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var user1MemberInfo = new MemberInfo { Id = 1, Class = "string", Birthdate = new DateTime(2025,1,1), FullName = "string", MemberId = "string", Nation = "string", religion = "string", PhoneNumber = "string", UrlAvatar = "string", PoliticalTheory = "string", DateOfJoining = new DateTime(2025, 1, 1), PlaceOfJoining = "string", IsOutstandingMember = false, Status = MemberInfoEnum.studying, UserId = 1 };
            var user2MemberInfo = new MemberInfo { Id = 2, Class = "string", Birthdate = new DateTime(2025, 1, 1), FullName = "string", MemberId = "string", Nation = "string", religion = "string", PhoneNumber = "string", UrlAvatar = "string", PoliticalTheory = "string", DateOfJoining = new DateTime(2025, 1, 1), PlaceOfJoining = "string", IsOutstandingMember = false, Status = MemberInfoEnum.studying, UserId = 2 };
            var user3MemberInfo = new MemberInfo { Id = 3, Class = "string", Birthdate = new DateTime(2025, 1, 1), FullName = "string", MemberId = "string", Nation = "string", religion = "string", PhoneNumber = "string", UrlAvatar = "string", PoliticalTheory = "string", DateOfJoining = new DateTime(2025, 1, 1), PlaceOfJoining = "string", IsOutstandingMember = false, Status = MemberInfoEnum.studying, UserId = 3 };
